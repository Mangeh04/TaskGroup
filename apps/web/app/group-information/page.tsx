...
type DeveloperData = MemberCardProps & { status: MemberStatus };
      ...
      <SidebarProvider>
        ...
        <SidebarInset className="flex flex-1 min-h-0 flex-col bg-white dark:bg-neutral-950">
          <header className="relative flex h-14 shrink-0 items-center gap-6 px-4 border-b">
            <SidebarTrigger />
            <h1 className="text-lg font-semibold">Development Team</h1>
          </header>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="mb-8">
                ...
                <p className="text-muted-foreground mt-2">
                  Somos un grupo de estudiantes de la ESEI (Universidade de
                  Vigo) desarrollando TaskGroup para la asignatura de TSW.
                </p>
              </div>
