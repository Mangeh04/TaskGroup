...
import { InviteMemberDialog } from "@/app/dashboard/projectdetails/settings/components/inviteMembersDialog";
...
export function TeamSettings({
  ...
  const updateRole = (id: string, role: "Owner" | "Admin" | "Member") => {
          ...
          {members.map((m) => (
            ...
            >
              ...
              <div className="md:col-span-4">
                <Select
                  value={m.role}
                  onValueChange={(v) => updateRole(m.id, v as any)}
                >
